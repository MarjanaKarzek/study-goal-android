...
import com.studygoal.jisc.Utils.DatePicker.DatePickerDialogFragment;
...
public class LogLogActivityFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mainView = inflater.inflate(R.layout.layout_log_log_activity, container, false);
            ...
            case R.id.log_activity_save_btn: {
                ...
                if (isInEditMode) {
                    ...
                    if (DataManager.getInstance().user.email.equals("demouser@jisc.ac.uk")) {
                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(LogLogActivityFragment.this.getActivity());
